...
class CNNModel(nn.Module):
    def __init__(self):
        ...
        # conv 1
        self.con1 = nn.Conv2d(in_channels=1, out_channels=16, kernel_size=5, stride=1, padding=0)
        self.relu1 = nn.ReLU()
        ...
        # conv 2
        self.con2 = nn.Conv2d(in_channels=16, out_channels=32, kernel_size=5, stride=1, padding=0)
        self.relu2 = nn.ReLU()
